...
$(SECTION_NAV_SEL).css('margin-top','-'+($(SECTION_NAV_SEL).height()/2)+'px');$(window).on('resize',function(){$(SECTION_NAV_SEL).css('margin-top','-'+($(SECTION_NAV_SEL).height()/2)+'px');});$(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).addClass(ACTIVE);$(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)+2).addClass('near');$(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)+1).addClass('nearest');$(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).find('a').addClass(ACTIVE);}
...
slidesNav.find(ACTIVE_SEL).removeClass(ACTIVE);slidesNav.find('li').eq(slideIndex).addClass(ACTIVE);slidesNav.find('li').eq(slideIndex).find('a').addClass(ACTIVE);changeTab(slideIndex);}
function changeTab(indexOfActiveTab){$($('#fp-nav li')[indexOfActiveTab]).removeClass('past');if($('#fp-nav li')[indexOfActiveTab-1]){$($('#fp-nav li')[indexOfActiveTab-1]).addClass('past').removeClass('near').addClass('nearest');}
if($('#fp-nav li')[indexOfActiveTab-2]){$($('#fp-nav li')[indexOfActiveTab-2]).addClass('past').removeClass('nearest').addClass('near');}
if($('#fp-nav li')[indexOfActiveTab+1]){$($('#fp-nav li')[indexOfActiveTab+1]).removeClass('past').removeClass('near').addClass('nearest');}
if($('#fp-nav li')[indexOfActiveTab+2]){$($('#fp-nav li')[indexOfActiveTab+2]).removeClass('past').removeClass('nearest').addClass('near');}
var length=$('#fp-nav li').length;for(var i=indexOfActiveTab+3;i<length;i++){$($('#fp-nav li')[i]).removeClass('nearest').removeClass('near').removeClass('past');}
for(var i=indexOfActiveTab-3;i>=0;i--){$($('#fp-nav li')[i]).removeClass('nearest').removeClass('near').addClass('past');}}
...
function activateNavDots(name,sectionIndex){if(options.navigation){$(SECTION_NAV_SEL).find(ACTIVE_SEL).removeClass(ACTIVE);if(name){$(SECTION_NAV_SEL).find('a[href="#'+name+'"]').addClass(ACTIVE);}else{$(SECTION_NAV_SEL).find('li').eq(sectionIndex).addClass(ACTIVE);$(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addClass(ACTIVE);changeTab(sectionIndex);}}}
...
nav.css('margin-left','-'+(nav.width()/2)+'px');nav.find('li').first().addClass(ACTIVE);nav.find('li').first().find('a').addClass(ACTIVE);}
